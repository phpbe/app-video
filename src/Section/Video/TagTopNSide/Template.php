...
namespace Be\App\Video\Section\Video\TagTopNSide;
...
class Template extends Section
{
    ...
    private function css()
    {
        ...
        echo $this->getCssBackgroundColor('app-video-side-top-tags');
        echo $this->getCssPadding('app-video-side-top-tags');
        echo $this->getCssMargin('app-video-side-top-tags');

        echo '#' . $this->id . ' .app-video-side-top-tags {';
        ...
        echo '#' . $this->id . ' .app-video-side-top-tags:hover {';
        //echo 'box-shadow: 0 0 15px var(--font-color-8);';
        echo 'box-shadow: 0 0 15px #dae0e6;';
        echo '}';


        echo '#' . $this->id . ' .app-video-side-top-tags .tag {';
        echo 'color: #fff;';
        ...
        echo '#' . $this->id . ' .app-video-side-top-tags .tag:hover {';
        echo 'color: #fff;';
    ...
    public function display()
    {
        ...
        $topTags = Be::getService('App.Video.Video')->getTopTags($this->config->quantity);
        if (count($topTags) === 0) {
            return;
        }
        ...
        echo '<div class="app-video-side-top-tags">';
        ...
        foreach ($topTags as $topTag) {
            echo '<a class="tag" href="'. beUrl('Video.Video.tag', ['tag' => $topTag]) .'">' . $topTag . '</a> ';
        }
        echo '</div>';
