        ...
        <div class="be-row">
            <div class="be-col">
                <div style="padding: 1.25rem 0 0 2rem;">
                    <el-link icon="el-icon-back" href="<?php echo beAdminUrl('Video.Category.categories'); ?>">返回视频分类列表</el-link>
                </div>
            </div>
        ...
        <el-drawer
            ...
            <div class="be-px-150">
                ...
                <div class="be-row be-mt-150">
                    <div class="be-col-auto">
                        SEO描述
                        <el-tooltip effect="dark" content="这是该视频分类的整体SEO描述，使视频分类在搜索引擎中获得更高的排名。" placement="top">
                            <i class="el-icon-fa fa-question-circle-o"></i>
                        </el-tooltip>：
                    </div>
                    <div class="be-col">
                ...
                save: function (command) {
                    ...
                    this.$refs["formRef"].validate(function (valid) {
                        if (valid) {
                            ...
                            _this.$http.post("<?php echo beAdminUrl('Video.Category.' . ($this->category ? 'edit' :'create')); ?>", {
                                    ...
                                    if (responseData.success) {
                                        ...
                                        if (command === 'stay') {
                                            ...
                                            setTimeout(function () {
                                                ...
                                                window.location.href = "<?php echo beAdminUrl('Video.Category.categories'); ?>";
                                            }, 1000);
                                        }
                                    } else {
