        ...
        <div class="be-p-150 be-bc-fff">
            ...
            <div class="be-row be-lh-250 be-mt-50 be-bb be-pb-50">
                ...
                <div class="be-col-auto">
                    <el-link type="primary" icon="el-icon-refresh" :underline="false" href="<?php echo beAdminUrl('Video.CollectVideoApi.resetToken'); ?>">重新生成</el-link>
                </div>
            </div>
            ...
            <div class="be-row be-lh-250  be-mt-50 be-bb be-pb-50">
                ...
                <div class="be-col-auto be-px-100">
                    <el-tag>
                        <?php echo beUrl('Video.Api.CollectVideo', ['token' => $this->config->token]); ?>
                    </el-tag>
                </div>
    ...
    <script>
        let vueCenter = new Vue({
            ...
            methods: {
                toggleEnable() {
                    let _this = this;
                    _this.$http.get("<?php echo beAdminUrl('Video.CollectVideoApi.toggleEnable'); ?>", {
                ...
                copyUrl: function () {
                    ...
                    input.value = "<?php echo beUrl('Video.Api.CollectVideo', ['token' => $this->config->token]); ?>";
