...
<be-page-content>
    ...
    <div id="app" v-cloak>
        <div style="position: absolute; left: 0; right: 0; top: 0; bottom: 6rem; overflow-y: auto;">
            ...
            <div class="be-row collect-video" v-for="video, videoIndex in formData.videos" :key="video.id">
                <div class="be-col-12 be-pl-100">
                    {{video.title}}
                </div>
                <div class="be-col-12 be-ta-center">
                    <el-select
                            v-model="video.category_ids"
                            multiple
                            placeholder="请选择分类"
        ...
        let vueCenter = new Vue({
            ...
            methods: {
                save: function () {
                    let _this = this;
                    _this.loading = true;
                    _this.$http.post("<?php echo beAdminUrl('Video.Video.bulkEditCategorySave'); ?>", {
                ...
                setCategoryIds(val) {
                    for (let video of this.formData.videos) {
                        video.category_ids = val;
                    }
                }
            }
        });
