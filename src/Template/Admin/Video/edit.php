<be-head>
    <script src="<?php echo \Be\Be::getProperty('App.Video')->getWwwUrl(); ?>/admin/js/pinyin.js"></script>
    <style>
        ...
        <div class="be-row">
            <div class="be-col">
                <div style="padding: 1.25rem 0 0 2rem;">
                    <el-link icon="el-icon-back" href="<?php echo $this->backUrl; ?>">返回视频列表</el-link>
                </div>
            </div>
...
<be-page-content>
    ...
    <div id="app" v-cloak>
        <el-form ref="formRef" :model="formData" class="be-mb-400">
            <?php
            $formData['id'] = ($this->video ? $this->video->id : '');
            ?>
            ...
            <div class="be-row">
                <div class="be-col-24 be-xl-col">
                    <div class="be-p-150 be-bc-fff">
                        ...
                        <?php $formData['title'] = ($this->video ? $this->video->title : ''); ?>
                        ...
                        <?php $formData['summary'] = ($this->video ? $this->video->summary : ''); ?>
                        ...
                        $driver = new \Be\AdminPlugin\Form\Item\FormItemTinymce([
                            ...
                            'layout' => $this->configVideo->tinymceLayout,
                            'option' => $this->configVideo->tinymceOption,
                        ]);
                        echo $driver->getHtml();

                        $formData['description'] = ($this->video ? $this->video->description : '');
                        ...
                        <?php $formData['download_remote_image'] = ($this->video && $this->video->download_remote_image !== 0 ? 1 : 0); ?>
                ...
                <div class="be-col-24 be-xl-col-auto">
                    <div class="be-p-150 be-bc-fff" style="max-width: 400px;">
                        <?php
                        if ($this->video && $this->video->is_enable === -1) {
                            ...
                            <?php $formData['is_enable'] = ($this->video ? $this->video->is_enable : 0); ?>
                            ...
                            <?php $formData['is_push_home'] = ($this->video ? $this->video->is_push_home : 1); ?>
                            ...
                            <?php $formData['is_on_top'] = ($this->video ? $this->video->is_on_top : 0); ?>
                            <?php
                        }
                        ?>
                        ...
                        <?php
                        $formData['image'] = ($this->video ? $this->video->image : '');
                        ?>
                        ...
                        <?php
                        $formData['category_ids'] = ($this->video ? $this->video->category_ids : []);
                        ?>
                        ...
                        <?php
                        $formData['tags'] = ($this->video ? $this->video->tags : []);
                        ...
                        <?php
                        $formData['author'] = ($this->video ? $this->video->author : \Be\Be::getAdminUser()->name);
                        ?>
                        ...
                        <?php
                        $formData['publish_time'] = ($this->video ? $this->video->publish_time : date('Y-m-d H:i:s'));
                        ?>
                        ...
                        <?php $formData['ordering'] = ($this->video ? $this->video->ordering : ''); ?>
                    ...
                    <div class="be-p-150 be-bc-fff be-mt-200"  style="max-width: 400px;">
                        ...
                        <div class="be-mt-100 be-t-break be-c-999 be-fs-80"><?php echo $rootUrl . $this->configVideo->urlPrefix; ?>{{formData.url}}</div>
        ...
        <el-drawer
            ...
            <div class="be-px-150">
                ...
                <?php
                $formData['seo_title'] = ($this->video ? $this->video->seo_title : '');
                $formData['seo_title_custom'] = ($this->video ? $this->video->seo_title_custom : 0);
                ?>
                ...
                <?php
                $formData['seo_description'] = ($this->video ? $this->video->seo_description : '');
                $formData['seo_description_custom'] = ($this->video ? $this->video->seo_description_custom : 0);
                ?>
                ...
                <el-input
                    ...
                    <template slot="prepend"><?php echo $rootUrl . $this->configVideo->urlPrefix; ?></template>
                </el-input>
                <?php
                $formData['url'] = ($this->video ? $this->video->url : '');
                $formData['url_custom'] = ($this->video ? $this->video->url_custom : 0);
                ?>
                ...
                <?php
                $formData['seo_keywords'] = ($this->video ? $this->video->seo_keywords : '');
                ?>
                            ...
                            _this.$http.post("<?php echo $this->formActionUrl; ?>", {
                                ...
                                if (response.status === 200) {
                                    ...
                                    if (responseData.success) {
                                        ...
                                        if (command === 'stay') {
                                            _this.formData.id = responseData.video.id;
                                        } else {
                                            setTimeout(function () {
