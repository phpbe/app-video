...
class Es extends Auth
{
    ...
    public function dashboard()
    {
        ...
        $indexes = Be::getService('App.Video.Admin.Es')->getIndexes();
    ...
    public function createIndex()
    {
        ...
        try {
            Be::getService('App.Video.Admin.Es')->createIndex($indexName, $formData);
    ...
    public function deleteIndex()
    {
        ...
        $indexName = $formData['name'] ?? '';
        try {
            Be::getService('App.Video.Admin.Es')->deleteIndex($indexName);
