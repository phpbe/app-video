...
`video_collect_id` varchar(36) NOT NULL DEFAULT '' COMMENT '采集的视频ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='视频';
...
`id` varchar(36) NOT NULL DEFAULT 'uuid()' COMMENT 'UUID',
`video_id` varchar(36) NOT NULL DEFAULT '' COMMENT '视频ID',
`video_item_id` varchar(36) NOT NULL DEFAULT '' COMMENT '视频子项ID',
...
`create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='视频图像';

ALTER TABLE `video_image`
ADD PRIMARY KEY (`id`),
ADD KEY `video_id` (`video_id`,`video_item_id`,`is_main`) USING BTREE;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='视频标签';

ALTER TABLE `video_tag`
ADD PRIMARY KEY (`id`),
ADD UNIQUE KEY `video_tag` (`video_id`,`tag`) USING BTREE;
...
`create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='视频子项';
...
CREATE TABLE `video_category_id` (
`id` varchar(36) NOT NULL DEFAULT 'uuid()' COMMENT 'UUID',
`video_id` varchar(36) NOT NULL DEFAULT '' COMMENT '视频ID',
`category_id` varchar(36) NOT NULL DEFAULT '' COMMENT '视频分类ID'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='视频的分类';

ALTER TABLE `video_category_id`
ADD PRIMARY KEY (`id`),
ADD UNIQUE KEY `video_id` (`video_id`,`category_id`) USING BTREE,
...
`create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='视频评论';
...
`create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci COMMENT='采集的视频';
